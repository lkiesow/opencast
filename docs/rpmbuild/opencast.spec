...
Name:          eth-opencast-%{ocdist}
Version:       %{_opencastversion}
Release:       %{_opencastrelease}%{?dist}
Summary:       Open Source Lecture Capture & Video Management Tool

Group:         Applications/Multimedia
License:       ECL 2.0
URL:           http://opencast.org
Source0:       opencast-dist-%{ocdist}-%{_opencastsrcversion}.tar.gz
Source1:       jetty.xml
...
%changelog
* Wed May 02 2018 Waldemar Smirnow <wsmirnow@uos.de> - 5.0-1
- Restart Opencast Systemd service on update
