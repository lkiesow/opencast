...
public class IliasDistributionServiceImplTest {
  ...
  private IliasDistributionServiceImpl service = null;
  ...
  public void testPartialDistribution() throws Exception {
    ...
    Job job1 = service.distribute("ilias", mp, "track-1");
    Job job2 = service.distribute("ilias", mp, "catalog-1");
  ...
  public void testRetractByOriginal() throws Exception {
    ...
    Job job1 = service.distribute("ilias", mp, "track-1");
    Job job2 = service.distribute("ilias", mp, "catalog-1");
    Job job3 = service.distribute("ilias", mp, "catalog-2");
    Job job4 = service.distribute("ilias", mp, "notes");
    JobBarrier jobBarrier = new JobBarrier(null,serviceRegistry, 500, job1, job2, job3, job4);
    jobBarrier.waitForJobs();
    ...
    Job job6 = service.retract("ilias", mp, null);
    jobBarrier = new JobBarrier(null, serviceRegistry, 500, job6);
    jobBarrier.waitForJobs();
  ...
  public void testRetractByDistributed() throws Exception {
    ...
    // Now retract the mediapackage and ensure that the distributed files have been removed
    Job job6 = service.retract("ilias", mp, job1Element.getIdentifier());
    jobBarrier = new JobBarrier(null, serviceRegistry, 500, job6);
    jobBarrier.waitForJobs();
