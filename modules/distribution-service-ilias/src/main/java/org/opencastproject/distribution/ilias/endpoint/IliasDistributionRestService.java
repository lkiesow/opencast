 ...
 *
 */
package org.opencastproject.distribution.ilias.endpoint;
...
@RestService(name = "localdistributionservice", title = "Local Distribution Service",
  abstractText = "This service distributes media packages to the file system for ILIAS.",
  notes = {
...
public class IliasDistributionRestService extends AbstractJobProducerEndpoint {

  /** The logger */
  private static final Logger logger = LoggerFactory.getLogger(IliasDistributionRestService.class);
